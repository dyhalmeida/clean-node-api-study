...
describe('Auth UseCase', () => {
  ...
  test('Should return null if LoadUserByEmailRepository returns nul', async () => {
    const { sut } = makeSut()
    const accessToken = await sut.auth({ email: 'invalid_email@mail.com', password: 'any_password' })
